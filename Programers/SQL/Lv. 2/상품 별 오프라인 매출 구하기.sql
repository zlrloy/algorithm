...
-- 풀이
SELECT PT.PRODUCT_CODE, SUM(PT.PRICE * OS.SALES_AMOUNT) AS SALES
FROM PRODUCT PT
INNER JOIN OFFLINE_SALE OS ON PT.PRODUCT_ID = OS.PRODUCT_ID
GROUP BY PT.PRODUCT_CODE
ORDER BY SALES DESC, PT.PRODUCT_CODE